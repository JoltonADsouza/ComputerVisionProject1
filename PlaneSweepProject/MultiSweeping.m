...
n = [0 0 -1]';
n1 = r01*n; %oriented plane normal
n2 = r02*n;
...
[i1_warped] = ImageWarping(i1, i_ref, depth_range,k1,r01,t01,n,k_ref,no_of_planes,z_step);
[i2_warped] = ImageWarping(i2, i_ref, depth_range,k2,r02,t02,n,k_ref,no_of_planes,z_step);

[i1_warped_or1] = ImageWarping(i1, i_ref, depth_range,k1,r01,t01,n1,k_ref,no_of_planes,z_step);
[i2_warped_or1] = ImageWarping(i2, i_ref, depth_range,k2,r02,t02,n1,k_ref,no_of_planes,z_step);

[i1_warped_or2] = ImageWarping(i1, i_ref, depth_range,k1,r01,t01,n2,k_ref,no_of_planes,z_step);
[i2_warped_or2] = ImageWarping(i2, i_ref, depth_range,k2,r02,t02,n2,k_ref,no_of_planes,z_step);

% [depth_map1] = SAD(255*rgb2gray(i_ref), i1_warped, i2_warped, depth_range, n, k_ref, 3);
[depth_map] = SAD_Multisweep(255*rgb2gray(i_ref), i2_warped,i2_warped_or1,i2_warped_or2, i1_warped,i1_warped_or1,i1_warped_or2, depth_range, k_ref, n', n1', n2');
